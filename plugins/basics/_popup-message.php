...
<html lang="<?php echo eLang::get_lang()?>">
	...
	<body>
		<!-- START OF PAGE -->
		<div class="close_btn closing_cross">X</div>
<?php 	
...
?>
		...
		<form id="message" method="post" action="">
			<div class="col unicol actions_block">				
...
?>
					<input type="button" class="button close_btn" name="cancel_btn" value="<?php echo eText::iso_htmlentities(eLang::translate($_GET['cancel'], "ucfirst")); ?>" />
<?php
	}
?>
