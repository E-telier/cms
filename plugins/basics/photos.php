...
<?php
			...
			for ($d=0;$d<$nb_dossiers;$d++) {
				...
				$fakedir = eMain::get_requested_url()."/".$dir;
?>			
			<div class="album">
				<div class="img left"><a href="<?php echo $fakedir; ?>"><img src="<?php echo $realpath."/".$thumbfile; ?>" width="160" height="120" alt="<?php echo eText::style_to_html($dir); ?>" border="0" /></a></div>
				<div class="label"><a href="<?php echo $fakedir; ?>"><?php echo eText::style_to_html($dir); ?></a></div>
			</div>
<?php
